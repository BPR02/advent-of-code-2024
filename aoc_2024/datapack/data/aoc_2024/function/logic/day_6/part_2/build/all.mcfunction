...
function aoc_2024:logic/day_6/part_2/build/line

data remove storage aoc:register input[0]
scoreboard players remove line_count aoc_calc 1
execute if score line_count aoc_calc matches 1.. positioned ~ ~ ~1 run function aoc_2024:logic/day_6/part_2/build/all
