...
function aoc_2024:logic/day_6/part_1/clean_up
execute positioned 0 64 0 run function aoc_2024:logic/day_6/part_1/build/all
...
function aoc_2024:logic/day_6/part_1/path/start with storage aoc:register temp
