...
execute positioned ~ ~1 ~2 run function aoc_lib:api/stack/push_block {name:"day_4",id:"gold_block"}
execute positioned ~ ~1 ~3 run function aoc_lib:api/stack/push_block {name:"day_4",id:"gold_block"}
